...
const MetaIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" style={{ width: '100%', height: '100%' }}>
    <path d="M16.5 6a5.5 5.5 0 0 0-4.5 2.37A5.5 5.5 0 0 0 7.5 6a5.5 5.5 0 1 0 0 11a5.5 5.5 0 0 0 4.5-2.37A5.5 5.5 0 0 0 16.5 17a5.5 5.5 0 1 0 0-11zm0 9a3.5 3.5 0 1 1 0-7c1.13 0 2 .87 2 2s-.87 2-2 2h-1c-.55 0-1 .45-1 1s.45 1 1 1h1c1.13 0 2 .87 2 2s-.87 2-2 2zM7.5 15A3.5 3.5 0 1 1 7.5 8c1.13 0 2 .87 2 2s-.87 2-2 2h-1c-.55 0-1 .45-1 1s.45 1 1 1H7c1.13 0 2 .87 2 2s-.87 2-2 2z" fill="#1877f2" />
  </svg>
);

const GoogleAdsIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" style={{ width: '100%', height: '100%' }}>
    <path d="M17.5 3.5L6.5 20.5h11L23 3.5h-5.5z" fill="#4285F4" />
    <path d="M6.5 20.5L1 11.5 6.5 3.5 12 12.5l-5.5 8z" fill="#F4B400" />
  </svg>
);

const AdPostingIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{ width: '100%', height: '100%', stroke: 'var(--success)' }}>
    <path d="m3 11 18-5v12L3 13v-2Z" />
    <path d="M11.6 16.8 14 21h4l-3-6" />
...
const techData = [
  ...
  },
  {
    name: 'Google Ads',
    category: 'Social Media',
    glowClass: 'glow-google-ads',
    isGoogleAds: true
  },
  {
    name: 'Ad Posting',
    category: 'Social Media',
    glowClass: 'glow-ad-posting',
    isAdPosting: true
  },
  {
    name: 'MVPs & Launch',
...
export default function TechStack() {
  const midpoint = Math.ceil(techData.length / 2);
  const row1 = techData.slice(0, midpoint);
  const row2 = techData.slice(midpoint);
  ...
  const renderIcon = (tech) => {
    ...
    if (tech.isMeta) return <MetaIcon />;
    if (tech.isGoogleAds) return <GoogleAdsIcon />;
    if (tech.isAdPosting) return <AdPostingIcon />;
