        ...
        <div className="contact-page-grid">
          ...
          <div className="contact-info-column reveal reveal-slide-left">
            ...
            <div className="contact-channels-list">
              ...
              >
                <div className="channel-icon-box whatsapp-theme" style={{ background: 'rgba(37, 211, 102, 0.15)', borderColor: 'rgba(37, 211, 102, 0.4)', color: '#25d366' }}>
                ...
                <div className="channel-details">
                  ...
                  <p className="channel-value" style={{ color: '#25d366' }}>Chat Live With Us</p>
...
15, Thainganagar, Sri Poonkuyil Nagar, Vengamedu, Karur, Tamil Nadu 639006</p>
            ...
            <div className="contact-socials-box glass-panel text-center">
              ...
              <div className="contact-socials-row">
                <a href={settings.whatsappUrl || "https://wa.me/919360410038?text=I%20would%20like%20to%20discuss%20a%20new%20project!"} target="_blank" rel="noopener noreferrer" className="social-circle-btn social-whatsapp" title="WhatsApp">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.521.151-.172.2-.296.3-.495.099-.198.05-.372-.025-.521-.075-.148-.669-1.611-.916-2.206-.242-.579-.487-.501-.669-.51l-.57-.01c-.198 0-.52.074-.792.372s-1.04 1.016-1.04 2.479 1.065 2.876 1.213 3.074c.149.198 2.095 3.2 5.076 4.487.709.306 1.263.489 1.694.626.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.695.248-1.29.173-1.414-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.99c-.002 5.45-4.437 9.887-9.885 9.887m0-18.067c-5.83 0-10.57 4.74-10.573 10.57a10.52 10.52 0 001.597 5.56l-1.697 6.2 6.34-1.662a10.5 10.5 0 005.328 1.455h.005c5.829 0 10.57-4.74 10.573-10.57a10.505 10.505 0 00-3.097-7.469c-1.972-1.972-4.595-3.058-7.472-3.058" />
                  </svg>
                </a>
                <a href="https://x.com/Corelixtech" target="_blank" rel="noopener noreferrer" className="social-circle-btn social-twitter" title="Twitter / X">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z" />
                  </svg>
                </a>
                <a href="https://www.linkedin.com/in/corelix-technology/" target="_blank" rel="noopener noreferrer" className="social-circle-btn social-linkedin" title="LinkedIn">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <a href="https://www.youtube.com/@Corelixtechnology" target="_blank" rel="noopener noreferrer" className="social-circle-btn social-youtube" title="YouTube">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M10 8v8l6-4-6-4z" />
                    <circle cx="12" cy="12" r="10" />
                  </svg>
                </a>
                <a href="https://www.instagram.com/corelixtechnology" target="_blank" rel="noopener noreferrer" className="social-circle-btn social-instagram" title="Instagram">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
