  ...
  return (
    <section id="about" className="section">
      ...
      <div className="container">
        <h2 className="section-title reveal reveal-slide-up">About Us</h2>
        ...
        {/* Tab Selection */}
        <div className="about-profile-toggle reveal reveal-fade-in" data-delay="0.2s">
          <button 
            data-tab="profile"
        ...
        {activeTab === 'profile' && (
          <div className="company-profile-pane glass-panel reveal reveal-fade-in">
          ...
          <div className="founders-pane">
            <div className="founders-grid" style={{ gridTemplateColumns: '1fr', justifyItems: 'center' }}>
              {founders.map((founder, idx) => (
                <div key={idx} className="founder-card glass-panel reveal reveal-scale-up" style={{ maxWidth: '600px', width: '100%' }}>
                  ...
                  {/* RPG Stats */}
                  <div className="founder-rpg-stats reveal-stagger">
                    <h4 className="stats-title">Key Competencies</h4>
                    {founder.stats.map((stat, sIdx) => (
                      <div key={sIdx} className="rpg-stat-row reveal-item reveal-slide-up">
